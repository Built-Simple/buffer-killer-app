...
class GitHubBrowserAuth {
  constructor() {
    ...
    this.clientId = 'Ov23liJhGsLSW0RPuVFp'; // Buffer Killer public client ID
  ...
  async exchangeCodeForToken(code, state) {
    ...
    try {
      // For public clients, we can't use client_secret
      // GitHub will validate based on the redirect URI and client ID
      const params = {
        client_id: this.clientId,
        code: code,
        redirect_uri: this.redirectUri
